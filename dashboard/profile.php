      ...
      <nav class="navbar navbar-default navbar-fixed-top">
        <div class="container">
          ...
          <div class="navbar-header page-scroll">
            ...
            <a class="navbar-brand page-scroll" href="../index"><img src="../logo/logo.png" width="115" height="30" alt="hubcarimg" /></a>Profilo </div>
           ...
           <?php }?>
            ...
            <div class="col-md-4 features-left">
              ...
              <!--dati automobile, max 2-->
                ...
                <!----->
                <div class="feature-single">
                 <a href="automobile" class="btn btn-action wow fadeInUp" style="visibility: visible; animation-name: fadeInUp;">Modifica Auto</a>
