$(document).ready(function(){
           ...
           var mess1="<div class='col-md-12 wow fadeInDown text-center' data-wow-delay='0.2s'> <div class='pitch-content text-center'> <h1>Nessuna prenotazione in corso</h1>";
           var mess2="</div><a href='../foundtravel' class='btn btn-action wow fadeInUp' style='visibility: visible; animation-name: fadeInUp;'>Cerca un viaggio</a>";
           var mess3="</div></div> </div> </div> </div>";
            var messtotal= mess+mess1+mess2+mess3;
            //fine messaggio
 
     $.post( "../data/travel.php",{'book': 1}, function(response) {
                   ...
                   if(response[i].posti===1)
                   ...
                   else
                     {
                        posti=response[i].posti+" posti disponibili";
                          ...
                          var p="<form action='show-travel-booked' method='POST'><div style='float:center;'>";
