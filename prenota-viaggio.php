...
?>
  ...
  <head>
    ...
    <script type="text/javascript" src="js/book-travel.js"></script>
  ...
  <body>
    ...
    <div class="main app form" id="main">
      ...
      <div id="fh5co-contact" class="container">
        <form action="dashboard/book-travel" method="POST" name="modulo">
          <div class="app-features text-center" id="cerca">
            ...
            <div class="col-md-12 wow fadeInDown text-center features-left" data-wow-delay="0.2s" >              
              ...
              <div class="col-md-4 wow fadeInDown text-center" data-wow-delay="0.2s" >
                    <div class="feature-single">
                      <h1 style='color:#1eb858'>Seleziona i posti</h1>
                       <div class='form-group text-center'>
                        <select id="posti" class="form-control" name="posti" value="" style="font-family: 'Open Sans', sans-serif;background: #F8F8F8; -webkit-appearance: none;">
                     ...
                     <div class='form-group text-center'>
                        <input type='submit' value='prenota'  class="btn btn-primary btn-action btn-fill" name="crea">
                      </div>
                  </div>
