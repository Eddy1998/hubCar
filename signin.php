            ...
            <div class="container">
              <div class="col-md-12 col-sm-12 nopadding">
				...
				<div class="pricing-intro">
                  <h1 class="wow fadeInUp" data-wow-delay="0s">Oppure:</h1>
                  <p class="wow fadeInUp" data-wow-delay="0.2s"><a class="btn btn-primary btn-action btn-fill" href="signup.php" type="button" >Crea un'account</a></p>
                </div>
              </div>
            </div>
          </div>
